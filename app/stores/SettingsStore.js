...
const CORE_ASSET = "EON"; // Setting this to EON to prevent loading issues when used with EON chain which is the most usual case currently
...
class SettingsStore {
    ...
    init() {
        return new Promise(resolve => {
            ...
            let topMarkets = {
                markets_b07219d3: getMyMarketsQuotes(),
                markets_39f5e2ed: [
                    // TESTNET
                    "PEG.FAKEUSD",
                    "BTWTY"
            ...
            let bases = {
                markets_b07219d3: getMyMarketsBases(),
                markets_39f5e2ed: [
                    // TESTNET
                    "TEST"
                ]
            ...
            let coreAssets = {
                markets_b07219d3: "EON",
                markets_39f5e2ed: "TEST"
            };
            let coreAsset = coreAssets[this.starredKey] || "EON";
            /*
            ...
            */
            ...
            let defaultBases = bases[this.starredKey] || bases.markets_b07219d3;
    ...
    _getChainId() {
        return (Apis.instance().chain_id || "b07219d3").substr(0, 8);
    }
