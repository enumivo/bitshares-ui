...
In Eidos, each account is separated into
...
In Eidos an *authority* consists of one or many entities that authorize an
...
must sign in order for the transaction to be valid. Now, in Eidos, we have
