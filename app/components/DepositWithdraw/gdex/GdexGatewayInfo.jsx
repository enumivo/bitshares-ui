...
class GdexGatewayInfo extends React.Component {
    ...
    render() {
        ...
        if (
            ...
            return emptyRow;
        const {coin, eonCoin} = this.props;
        // asset is not loaded
        if (!eonCoin) return emptyRow;
        ...
        if (account_balances_object)
            balance = account_balances_object.toJS()[eonCoin.get("id")];
