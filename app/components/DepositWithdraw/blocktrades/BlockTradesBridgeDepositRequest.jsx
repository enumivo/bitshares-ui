    ...
    urlConnection(checkUrl, state_coin_info) {
        ...
        Promise.all([
            ...
            .then(json_responses => {
                ...
                let allowed_mappings_for_deposit = {}; // all non-eon to eon
                let allowed_mappings_for_withdraw = {}; // all eon to non-eon
                let allowed_mappings_for_conversion = {}; // all eon to eon
