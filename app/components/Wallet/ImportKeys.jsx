...
class ImportKeys extends Component {
    ...
    /** EON 1.0 client wallet_export_keys format. */
    _parseImportKeyUpload(json_contents, file_name, update_state) {
        ...
        // EON 1.0 wallets may have a lot of generated but unused keys or spent TITAN addresses making
    ...
    */
    _parseWalletJson(json_contents) {
        ...
        let savePubkeyAccount = function(pubkey, account_name) {
            ...
            address = "EON" + address.substring(3);
        ...
        try {
            ...
            if (!encrypted_brainkey)
                throw "Please use a EON 1.0 wallet_export_keys file instead";
                        ...
                        <div>
                            <div>
                                {privateKey ? (
                                    ...
                                    >
                                        <label>
                                            <Translate content="wallet.eon_09_export" />
